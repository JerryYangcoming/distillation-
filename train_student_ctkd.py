...
def parse_option():
    ...
    # dataset
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['cifar100', 'imagenet', 'imagenette'],
                        help='dataset')
...
def main_worker(gpu, ngpus_per_node, opt):
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        train_acc, train_acc_top5, train_loss, temp = train(epoch, train_loader, module_list, mlp, decay_value,
